function Navigation() {
  try {
    ...
    return (
      <nav className={`fixed top-0 w-full z-50 border-b border-white/10 transition-all duration-300 ${isScrolled ? 'navbar-shrink glass-slide' : 'glass-slide'}`} data-name="navigation" data-file="components/Navigation.js" aria-label="Main navigation">
