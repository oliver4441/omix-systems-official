        ...
        <section id="about" className="page-section relative overflow-hidden" data-name="about" data-file="components/About.js">
          ...
          <div className="container relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
              {values.map((v, i) => (
                <div key={i} className="glass-card p-6 text-center hover-lift transition-all duration-300">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--secondary-color)] to-[var(--accent-color)] flex items-center justify-center mx-auto mb-4 text-white font-bold text-lg">
            ...
            <div className="text-center mb-16">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {["React", "Node.js", "Python", "PostgreSQL", "MongoDB", "AWS", "Vercel", "Docker", "TypeScript", "GraphQL"].map((tech, i) => (
                  <span key={i} className="px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-sm font-medium text-[var(--text-secondary)] hover:border-[var(--accent-color)]/30 hover:text-[var(--text-primary)] transition-colors">
                    {tech}
                  </span>
                ))}
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {steps.map((step, i) => (
                <div key={i} className="text-center relative">
                  ...
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[var(--secondary-color)] to-[var(--accent-color)] flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold">
                    {step.num}
                  </div>
